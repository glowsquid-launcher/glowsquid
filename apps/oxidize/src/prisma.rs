...
pub mod modpack {
  ...
  pub fn modpack_id_adapter<T: From<UniqueWhereParam>>(modpack_id: String, adapter: String) -> T {
    UniqueWhereParam::ModpackIdAdapterEquals(modpack_id, adapter).into()
  }
  pub fn _outputs() -> Vec<Selection> {
    [
      "modpackId",
  ...
  pub enum WhereParam {
    ...
    Or(Vec<WhereParam>),
    And(Vec<WhereParam>),
    ModpackIdAdapterEquals(String, String),
  ...
  impl Into<SerializedWhere> for WhereParam {
    fn into(self) -> SerializedWhere {
      match self {
        ...
        Self::ModpackIdAdapterEquals(modpack_id, adapter) => (
          "modpackId_adapter".to_string(),
          SerializedWhereValue::Object(vec![
            ("modpackId".to_string(), PrismaValue::String(modpack_id)),
            ("adapter".to_string(), PrismaValue::String(adapter)),
          ]),
        ),
  ...
  impl From<UniqueWhereParam> for WhereParam {
    fn from(value: UniqueWhereParam) -> Self {
      match value {
        UniqueWhereParam::ModpackIdAdapterEquals(modpack_id, adapter) => {
          Self::ModpackIdAdapterEquals(modpack_id, adapter)
        }
      }
    }
...
pub mod minecraft_mod {
  ...
  pub fn mod_id_adapter<T: From<UniqueWhereParam>>(mod_id: String, adapter: String) -> T {
    UniqueWhereParam::ModIdAdapterEquals(mod_id, adapter).into()
  }
  pub fn _outputs() -> Vec<Selection> {
    [
      "modId",
  ...
  pub enum WhereParam {
    ...
    Or(Vec<WhereParam>),
    And(Vec<WhereParam>),
    ModIdAdapterEquals(String, String),
    ModIdEquals(String),
  ...
  impl Into<SerializedWhere> for WhereParam {
    fn into(self) -> SerializedWhere {
      match self {
        ...
        Self::ModIdAdapterEquals(mod_id, adapter) => (
          "modId_adapter".to_string(),
          SerializedWhereValue::Object(vec![
  ...
  impl From<UniqueWhereParam> for WhereParam {
    fn from(value: UniqueWhereParam) -> Self {
      match value {
        UniqueWhereParam::ModIdAdapterEquals(mod_id, adapter) => {
          Self::ModIdAdapterEquals(mod_id, adapter)
        }
      }
    }
